...
echo "   cat ~/.ssh/deploy_key   # paste this as DEPLOY_KEY in GitHub Actions secrets"
echo ""
...
echo "     S3_BUCKET_NAME=..."
echo "     EMAIL_SERVER=smtp://apikey:<SENDGRID_API_KEY>@smtp.sendgrid.net:587"
echo "     EMAIL_FROM=Heirloom <noreply@family.kevingaasch.com>"
echo ""
...
echo "   DEPLOY_HOST = <public IP or hostname of this instance>"
echo "   DEPLOY_KEY  = <contents of ~/.ssh/deploy_key>"
echo ""
