...
export async function POST(req: NextRequest, { params }: Params) {
  ...
  const prompt = `You are writing biographical narrative text for a private family history website. The tone is warm, archival, and historically grounded — like a well-researched family history book, not an encyclopedia.
